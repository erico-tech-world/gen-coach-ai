-- Fix authentication triggers and RLS policies
-- This migration ensures proper user profile creation and security
...
-- Insert profiles for any existing users that don't have profiles
INSERT INTO profiles (user_id, name)
SELECT 
  id, 
  COALESCE(
